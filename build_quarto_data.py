...
from gpx_analysis.site.data import ROUTES, build_route, ensure_dir, write_json
...
def main() -> None:
    ...
    write_route_pages_index(ROUTE_PAGES_DIR, ROUTES)
    ...
    write_quarto_config(ROUTES, QUARTO_CONFIG_PATH)
